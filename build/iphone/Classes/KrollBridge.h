...
@interface RSSReaderObject : KrollCoverageObject {
#else
@interface RSSReaderObject : KrollObject {
#endif
@private
...
extern NSString * RSSReader$ModuleRequireFormat;
