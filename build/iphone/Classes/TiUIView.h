...
/**
 Base class for all RSSReader views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the RSSReader view hierarchy (such as wrapped iOS UIViews) was touched.
